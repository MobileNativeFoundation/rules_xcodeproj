...
echo "\#(buildOutputGroupPrefix) $BAZEL_HOST_TARGET_ID_\#(hostIndex)" >> \#
...
"""#
        ...
        let expectedBuildPreActions: [XCScheme.ExecutionAction] = [.init(
            scriptText: #"""
mkdir -p "${BAZEL_BUILD_OUTPUT_GROUPS_FILE%/*}"
echo "\#(buildOutputGroupPrefix) $BAZEL_TARGET_ID" > \#
"$BAZEL_BUILD_OUTPUT_GROUPS_FILE"
\#(hostTargetOutputGroup)
"""#,
