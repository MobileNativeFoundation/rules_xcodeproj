...
"""#
    ...
    func test_xcode16_withoutBuildableFolders_doesNotSetPreferredProjectObjectVersion() {
        // Arrange

        let buildSettings = "{BUILD_SETTINGS_HERE}"
        let compatibilityVersion = "Xcode 15.0"
        let defaultXcodeConfiguration = "Debug"
...
"""#
    ...
    func test_xcode16_preferredProjectObjectVersion() {
        // Arrange

        let buildSettings = "{BUILD_SETTINGS_HERE}"
        let compatibilityVersion = "Xcode 16.0"
        let defaultXcodeConfiguration = "Debug"
        let developmentRegion = "en"
        let minimumXcodeVersion: SemanticVersion = "16.0"
        let organizationName: String? = nil
