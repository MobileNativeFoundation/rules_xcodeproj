...
- List of declared Swift explicit-module manifest paths, terminated by an empty argument
- List of prepared Swift/module-map paths for index imports, terminated by an empty argument
