    ...
    func assertScheme(
        ...
        var expectedBuildPreActions: [XCScheme.ExecutionAction] = [
            ...
            .init(
                ...
                name: expectedTargetInfo.buildableReference.blueprintName
            ),
        ]
        if let expectedHostBuildableReference {
            expectedBuildPreActions.append(
                .init(
                    buildFor: expectedHostBuildableReference,
                    name: expectedHostBuildableReference.blueprintName
                )
            )
        }
