...
extension Target {
    static func mock(
        ...
        cParams: FilePath? = nil,
        cxxParams: FilePath? = nil,
        swiftParams: FilePath? = nil,
        cHasFortifySource: Bool = false,
        cxxHasFortifySource: Bool = false,
        ...
        return Target(
            ...
            cHasFortifySource: cHasFortifySource,
            cxxHasFortifySource: cxxHasFortifySource,
