...
run_generator_mode xojit NO YES bc,bf,bl,br _dbg_build
run_generator_mode xojit-coverage NO YES bc,bf,bl,br _dbg_build YES
run_generator_mode both YES YES bc,bf,bl,br _dbg_build
