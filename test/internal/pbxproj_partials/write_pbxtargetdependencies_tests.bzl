...
def _dict_to_xcode_target(d):
    return struct(
        ...
        product = struct(
            ...
            original_path = d["product_original_path"],
...
def mock_xcode_target(
    ...
    return struct(
        ...
        product_original_path = product_original_path,
        ...
        xcode_targets_by_label = {
            "//tools/generators/legacy/test:tests.__internal__.__test_bundle": {
                "//tools/generators/legacy/test:tests.__internal__.__test_bundle applebin_macos-darwin_x86_64-dbg-STABLE-3": mock_xcode_target(
                    ...
                    os_version = "16.2.1",
                    product_type = "u",
                    product_original_path = "bazel-out/applebin_macos-darwin_x86_64-dbg-STABLE-3/bin/tools/generators/legacy/test/tests.__internal__.__test_bundle_archive-root/tests.xctest",
            ...
            "//tools/generators/legacy:generator": {
                "//tools/generators/legacy:generator applebin_macos-darwin_x86_64-dbg-STABLE-3": mock_xcode_target(
                    ...
                    os_version = "12.0",
                    product_type = "T",
                    product_original_path = "bazel-out/applebin_macos-darwin_x86_64-dbg-STABLE-3/bin/tools/generators/legacy/generator",
            ...
            "//tools/generators/legacy:generator.library": {
                "//tools/generators/legacy:generator.library macos-x86_64-min12.0-applebin_macos-darwin_x86_64-dbg-STABLE-1": mock_xcode_target(
                    ...
                    os_version = "9.1",
                    product_type = "L",
                    product_original_path = "bazel-out/applebin_macos-darwin_x86_64-dbg-STABLE-3/bin/tools/generators/legacy/libgenerator.a",
