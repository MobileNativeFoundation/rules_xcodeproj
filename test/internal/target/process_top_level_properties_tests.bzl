...
def _process_top_level_properties_test_impl(ctx):
    ...
    asserts.equals(
        ...
        struct(
            file = struct(
                is_source = False,
                path = ctx.attr.expected_bundle_file,
            ),
...
process_top_level_properties_test = unittest.make(
    ...
    attrs = {
        ...
        "expected_bundle_file": attr.string(mandatory = False),
...
def process_top_level_properties_test_suite(name):
    ...
    def _add_test(
        ...
        process_top_level_properties_test(
            ...
            expected_bundle_file = expected_bundle_file,
    ...
    _add_test(
        ...
        bundle_info = None,
        tree_artifact_enabled = True,
        expected_bundle_file = "bazel-out/some/test.xctest/test",
    ...
    _add_test(
        ...
        tree_artifact_enabled = True,
        expected_bundle_file = "bazel-out/some/flagship.app",
    ...
    _add_test(
        ...
        tree_artifact_enabled = False,
        expected_bundle_file = "bazel-out/some/flagship.xctest",
