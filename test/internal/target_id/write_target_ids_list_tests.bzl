...
def write_target_ids_list_test_suite(name):
    ...
    _add_test(
        ...
        target_ids = [
            ...
            "@@//tools/lib/ToolCommon:ToolCommon macos-x86_64-min12.0-applebin_macos-darwin_x86_64-dbg-ST-c233c8334636",
            "@@//tools/lib/ToolCommon:ToolCommon macos-x86_64-min12.0-applebin_macos-darwin_x86_64-opt-ST-5e821ae22d1b",
