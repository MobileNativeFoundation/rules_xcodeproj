...
_SETTINGS = {
	"x86_64-apple-macosx generator": {
		...
		"s": [
			...
			"$(BUILD_DIR)/bazel-out/macos-x86_64-min13.0-applebin_macos-darwin_x86_64-opt-STABLE-2/bin/external/com_github_apple_swift_collections",
			"$(BUILD_DIR)/bazel-out/macos-x86_64-min13.0-applebin_macos-darwin_x86_64-opt-STABLE-2/bin/external/com_github_michaeleisel_zippyjson",
			"$(BUILD_DIR)/bazel-out/macos-x86_64-min13.0-applebin_macos-darwin_x86_64-opt-STABLE-2/bin/external/com_github_tuist_xcodeproj",
			"$(BUILD_DIR)/bazel-out/macos-x86_64-min13.0-applebin_macos-darwin_x86_64-opt-STABLE-2/bin/external/com_github_apple_swift_argument_parser",
			"$(BAZEL_OUT)/macos-x86_64-min13.0-applebin_macos-darwin_x86_64-opt-STABLE-2/bin/external/com_github_tadija_aexml",
			"$(BUILD_DIR)/bazel-out/macos-x86_64-min13.0-applebin_macos-darwin_x86_64-opt-STABLE-2/bin/external/com_github_kylef_pathkit",
