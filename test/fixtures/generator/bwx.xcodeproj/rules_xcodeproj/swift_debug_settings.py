...
_SETTINGS = {
  "x86_64-apple-macosx11.0.0 generator" : {
    "clang" : "-iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all",
    "frameworks" : [
  ...
  "x86_64-apple-macosx11.0.0 tests.xctest/Contents/MacOS/tests" : {
    "clang" : "-iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all -iquote \".\" -iquote \"$(BAZEL_OUT)/darwin_x86_64-dbg-ST-02316c4eb12c/bin\" -O0 -fstack-protector -fstack-protector-all",
    "frameworks" : [
