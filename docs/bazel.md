...
| <a id="xcodeproj-temporary_directory"></a>temporary_directory |  Optional. The directory where rules_xcodeproj will write some temporary files. The path is relative to the workspace root. Defaults to <code>.rules_xcodeproj</code>.   |  <code>".rules_xcodeproj"</code> |
