...
| <a id="xcodeproj-scheme_autogeneration_config"></a>scheme_autogeneration_config |  Optional. A struct returned by `xcschemes.autogeneration_config`.<br><br>Allows further configuration of `scheme_autogeneration_mode`.<br><br>Available configurations:<br><br><ul> <li>   `scheme_name_exclude_patterns`: Used to skip creating schemes matching provided regex patterns. </li> </ul>   |  `None` |
...
| Name  | Description | Default Value |
| :------------- | :------------- | :------------- |
| <a id="xcschemes.autogeneration_config-scheme_name_exclude_patterns"></a>scheme_name_exclude_patterns |  Dictionary containing configuration options.   |  `None` |
