...
| <a id="xcodeproj-scheme_autogeneration_config"></a>scheme_autogeneration_config |  Optional. A struct returned by `xcschemes.autogeneration_config`.<br><br>Allows further configuration of `scheme_autogeneration_mode`.<br><br>Available configurations:<br><br><ul> <li>   `xcschemes.autogeneration_exclude_patterns`: Used to skip creating schemes matching provided regex patterns. </li> </ul>   |  `None` |
...
<pre>
xcschemes.autogeneration_config(<a href="#xcschemes.autogeneration_config-exclude_patterns">exclude_patterns</a>)
</pre>
...
| Name  | Description | Default Value |
| :------------- | :------------- | :------------- |
| <a id="xcschemes.autogeneration_config-exclude_patterns"></a>exclude_patterns |  struct returned by `xcschemes.autogeneration_exclude_patterns`   |  `None` |
...
<a id="xcschemes.autogeneration_exclude_patterns"></a>

## xcschemes.autogeneration_exclude_patterns

<pre>
xcschemes.autogeneration_exclude_patterns(<a href="#xcschemes.autogeneration_exclude_patterns-target_name">target_name</a>)
</pre>
...
| Name  | Description | Default Value |
| :------------- | :------------- | :------------- |
| <a id="xcschemes.autogeneration_exclude_patterns-target_name"></a>target_name |  list of regex patterns to match on target name   |  `[]` |
