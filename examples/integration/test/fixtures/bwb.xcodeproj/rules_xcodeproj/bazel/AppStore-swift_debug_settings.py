...
_SETTINGS = {
	...
	"x86_64-apple-macosx proto": {
		"c": "-iquote$(PROJECT_DIR) -iquote$(PROJECT_DIR)/bazel-out/CONFIGURATION-STABLE-26/bin -Os -DNDEBUG=1 -Wno-unused-variable -Winit-self -Wno-extra",
		"s": [
			"$(PROJECT_DIR)/bazel-out/CONFIGURATION-STABLE-26/bin/external/rules_swift~~non_module_deps~com_github_apple_swift_protobuf",
