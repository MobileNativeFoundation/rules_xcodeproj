...
def _process_files_and_deps(
    ...
    def _handle_dep(dep):
        ...
        transitive_extra_file_paths.append(
            dep[XcodeProjInfo].inputs.uncategorized,
        )
    ...
    if CcInfo in target:
        ...
        extra_file_paths.extend(_process_cc_info_headers(
    ...
    return transitive_extra_file_paths, uncategorized, xccurrentversions
