...
def _xcodeproj_impl(ctx):
    ...
    simulator_infos_per_xcode_configuration = {}
    device_infos_per_xcode_configuration = {}
    for transition_key in (
        ...
        for xcode_configuration in xcode_configuration_map[transition_key]:
            simulator_infos_per_xcode_configuration[xcode_configuration] = (
                simulator_infos
            )
            device_infos_per_xcode_configuration[xcode_configuration] = (
                device_infos
            )
