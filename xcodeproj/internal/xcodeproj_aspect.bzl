...
def _xcodeproj_aspect_attrs(
    ...
    return {
        ...
        "_link_params_processor": attr.label(
            cfg = "exec",
            default = Label(
                "//tools/params_processors:link_params_processor",
            ),
            executable = True,
        ),
...
xcodeproj_aspect = struct(
    attrs = _xcodeproj_aspect_attrs,
    impl = _xcodeproj_aspect_impl,
)
