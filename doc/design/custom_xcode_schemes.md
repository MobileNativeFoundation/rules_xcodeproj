...
There are times when it is desirabe to customize the launch action with arguments and environment
...
- `all`: Generate a scheme for every buildable target even if custom schemes are provided.
