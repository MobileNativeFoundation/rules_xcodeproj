...
With this proposal, it is now possible to control how Xcode scheme autogeneration works.
The attribute, `scheme_autogeneration_mode`, accepts a `string` value. The value of
this attribute determines how Xcode scheme autogeneration occurs.
