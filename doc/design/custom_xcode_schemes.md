...
* [Outstanding Questions](#outstanding-questions)
  * [Scheme Merging: Can an xcode\_scheme include an xcode\_scheme in its targets?](#scheme-merging-can-an-xcode_scheme-include-an-xcode_scheme-in-its-targets)
    ...
    * [Scheme Merging Example](#scheme-merging-example-1)
    * [Scheme Merging Considerations](#scheme-merging-considerations-1)
    * [Concerns about Scheme Merging](#concerns-about-scheme-merging-1)
  * [Introduce schemes Attribute or Combine with the targets Attribut](#introduce-schemes-attribute-or-combine-with-the-targets-attribut)
  * [Should launch actions be inferred from targets in xcode\_scheme?](#should-launch-actions-be-inferred-from-targets-in-xcode_scheme)
  * [Should the launch\_action Attribute on xcode\_scheme Accept a Regular Target?](#should-the-launch_action-attribute-on-xcode_scheme-accept-a-regular-target)
